export const LanguageConstant = {
  ...
  loading: 'loading....',
  failedloadThemePreference: 'failedloadThemePreference',
  failedSaveThemePreference: 'failedSaveThemePreference',
  profileUpdated: 'profileUpdated',
  userDetails: 'userDetails',
  updateUserDeatils: 'updateUserDetails',
  emailSendMessage: 'emailSendMessage',
  noEmailFound: 'noEmailFound',
